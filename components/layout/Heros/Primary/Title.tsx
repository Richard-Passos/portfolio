...
const PrimaryHeroTitle = ({ className, children, ...props }: PrimaryHeroTitleProps) => {
  return (
    <Title
      className={cn('w-full tracking-tighter wrap-break-word uppercase lg:leading-none', className)}
      {...props}
    >
      {serialize(children, {
        paragraph: {
        ...
        alignText: {
          className: cn(
            'flex w-full flex-wrap justify-center gap-x-[.2em] text-center! [word-break:break-word]',
