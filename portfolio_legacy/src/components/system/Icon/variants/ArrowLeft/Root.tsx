...
type ArrowLeftIconRootProps = ComponentProps<'svg'>;

const ArrowLeftIconRoot = ({ className, ...props }: ArrowLeftIconRootProps) => {
  return (
    <svg
...
export { ArrowLeftIconRoot };
export type { ArrowLeftIconRootProps };
