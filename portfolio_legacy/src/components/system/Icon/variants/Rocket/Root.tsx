...
type RocketIconRootProps = ComponentProps<'svg'>;

const RocketIconRoot = ({ className, ...props }: RocketIconRootProps) => {
  return (
    <svg
...
export { RocketIconRoot };
export type { RocketIconRootProps };
