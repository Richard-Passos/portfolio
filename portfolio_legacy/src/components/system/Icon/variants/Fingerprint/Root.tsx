...
type FingerprintIconRootProps = ComponentProps<'svg'>;

const FingerprintIconRoot = ({
  className,
  ...props
}: FingerprintIconRootProps) => {
  return (
    <svg
...
export { FingerprintIconRoot };
export type { FingerprintIconRootProps };
