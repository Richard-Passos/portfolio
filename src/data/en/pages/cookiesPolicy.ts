...
const blocks: LegalPage['blocks'] = [
  ...
  {
    type: 'paragraph',
    children: [{ text: 'We use cookies for the following main purposes:' }]
  },
  {
    type: 'list',
    listType: 'unordered',
...
const cookiesPolicyPage: LegalPage = {
  ...(pages['cookies-policy'] as LegalPage),
  hero,
  blocks,
  footer
};
