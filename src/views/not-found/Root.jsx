...
const NotFoundView = ({ className, ...props }) => {
  return (
    <main
      className={cn(
        'dark-layout py-md dark relative flex flex-col items-center justify-center [--header-h:96px] max-2xl:min-h-[calc(100svh-var(--header-h))] 2xl:h-screen 2xl:max-h-bounds',
        className,
      )}
      {...props}
    >
