...
const AboutBackgroundSection = ({ className, ...props }) => {
  return (
    ...
    >
      ...
      <Text className='mt-[--gap] text-3xl font-medium max-sm:col-span-full sm:col-start-2 sm:col-end-13'>
        <TextScrollAnimation text={aboutText} />
      </Text>

      <section className='space-y-[--gap] max-sm:col-span-full sm:col-start-2 sm:col-end-9'>
      ...
      <section className='col-start-5 col-end-13 mt-2 flex flex-col gap-[--_gap] [--_gap:theme(spacing.4)] [--half-gap:calc(var(--_gap)/2)] sm:col-start-9'>
