        ...
        >
          <div className='top-0 sm:sticky'>
            <div className='relative mx-auto w-[95%] sm:scale-[--scale]'>
              <div className='relative mx-auto flex w-[90%] flex-col items-center justify-center gap-sm py-[--p] [--p:min(28vh,theme(spacing.28))] max-2xl:min-h-screen sm:[--p:min(14vh,theme(spacing.14))] lg:-translate-y-[--header-h] 2xl:h-screen 2xl:max-h-bounds'>
