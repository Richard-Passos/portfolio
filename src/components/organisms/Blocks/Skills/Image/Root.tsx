...
type SkillsBlockImageOrganismOwnProps = {
  data: {
...
type SkillsBlockImageOrganismProps = SkillsBlockImageOrganismOwnProps &
  Omit<ComponentProps<'div'>, keyof SkillsBlockImageOrganismOwnProps>;

const SkillsBlockImageOrganism = ({
  className,
  data,
  wrapperProps,
  imageProps,
  ...props
}: SkillsBlockImageOrganismProps) => {
  return (
    <div
      className={cn(
...
export default SkillsBlockImageOrganism;
export type { SkillsBlockImageOrganismProps };
