...
type GithubIconRootProps = ComponentProps<'svg'>;

const GithubIconRoot = ({ className, ...props }: GithubIconRootProps) => {
  return (
    <svg
...
export { GithubIconRoot };
export type { GithubIconRootProps };
