...
type GameControllerIconRootProps = ComponentProps<'svg'>;

const GameControllerIconRoot = ({
  className,
  ...props
}: GameControllerIconRootProps) => {
  return (
    <svg
...
export { GameControllerIconRoot };
export type { GameControllerIconRootProps };
