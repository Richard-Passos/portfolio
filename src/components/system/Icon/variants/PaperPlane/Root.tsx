...
type PaperPlaneIconRootProps = ComponentProps<'svg'>;

const PaperPlaneIconRoot = ({
  className,
  ...props
}: PaperPlaneIconRootProps) => {
  return (
    <svg
...
export { PaperPlaneIconRoot };
export type { PaperPlaneIconRootProps };
