...
const ListProjectsItem = ({
  ...
  return (
    ...
    >
      ...
      >
        <span className='overflow-hidden overflow-ellipsis whitespace-nowrap text-[clamp(1.5rem,4.4vw,4rem)] uppercase leading-none transition-transform duration-300 group-hover:-translate-x-6'>
          {title}
        </span>

        <span className='text-center text-[clamp(.75rem,1.3vw,1rem)] capitalize text-muted-content transition-transform duration-300 group-hover:translate-x-6'>
          {role}
        </span>
      </CursorLink>
    </li>
