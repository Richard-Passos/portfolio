...
const BentoGridItemLink = ({ className, data = {}, ...props }) => {
  ...
  return (
    <Item
        ...
        >
         <Link
            className='flex hover:primary size-full flex-col gap-1.5 rounded-inherit border bg-main p-sm no-underline transition-colors hover:focus-visible:outline-main'
            href={data.href}
          >
